I made this discord bot to detect some youtubers lives which are about ac6(but you can use for other than ac6).
...
2. edit env.json_template and rename to env.json
  ...
  5. Edit LIVE_TITLE_KEYWORDS to filter live titles you want to see
5. node bot.js
